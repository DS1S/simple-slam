...
SimpleSlam::Math::Vector3 SimpleSlam::Math::Vector3::cross(const Vector3& other) const {
...
double SimpleSlam::Math::Vector3::get_x() const {
    return _x;
}

double SimpleSlam::Math::Vector3::get_y() const {
    return _y;
}

double SimpleSlam::Math::Vector3::get_z() const {
    return _z;
}

SimpleSlam::Math::Vector3 SimpleSlam::Math::Vector3::operator*(double scalar) const {
...
SimpleSlam::Math::Vector2 SimpleSlam::Math::Vector2::operator+(const Vector2& other) const {
    return Vector2(_x + other._x, _y + other._y);
}

SimpleSlam::Math::Vector2 SimpleSlam::Math::Vector2::operator*(double scalar) const {
...
double SimpleSlam::Math::Vector2::get_x() const {
    return _x;
}

double SimpleSlam::Math::Vector2::get_y() const {
    return _y;
}
